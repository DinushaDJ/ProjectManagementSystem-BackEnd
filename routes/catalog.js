...
// GET request for creating a User. NOTE This must come before routes that display Task (phase id).
...
router.post('/user/:id/update', user_controller.user_delete_post);
